...
const T3_VALUES: Readonly<Record<string, string>> = {
  ...
  "--contrast-muted-foreground": "#a3a3a3",
  "--contrast-border": "#262626",
  "--contrast-input": "#303030",
  "--ring": "#4f46e5",
  "--primary": "#4f46e5",
  "--primary-foreground": "#ffffff",
  "--secondary": "#1f1f1f",
  "--contrast-secondary-foreground": "#f5f5f5",
  "--muted": "#1a1a1a",
  "--error": "#ef4444",
  ...
  // Before the contrast setting; T3 paints with the --contrast-* variants.
  "--foreground": "#ffffff",
  "--border": "#333333",
