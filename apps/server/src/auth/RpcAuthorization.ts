...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.pluginScreensUrl]: AuthOrchestrationReadScope,
  [WS_METHODS.pluginPackagesData]: AuthOrchestrationReadScope,
  [WS_METHODS.pluginPackagesDataSizes]: AuthOrchestrationReadScope,
  [WS_METHODS.pluginPackagesDeleteData]: AuthOrchestrationOperateScope,
